...
if not path.isfile(fname):
    ...
    for i in range(N_TWIST):
        a.set_twist(i)
        for j in enums.Axis:
            for k1 in range(4):  # three moves for each face, for example U, U2, U3 = U'
                a.corner_multiply(cb.basicMoveCube[j])
                for k2 in range(4):
                    a.corner_multiply(cb.basicMoveCube[j+3])
                    if not (k1 == 3 and k2 == 3):
                        twist_move[N_MOVE * i + 15 * j + 4 * k1 + k2] = a.get_twist()
    ...
    for i in range(N_FLIP):
        ...
        for j in enums.Axis:
            for k1 in range(4):  # three moves for each face, for example U, U2, U3 = U'
                ...
                for k2 in range(4):
                    a.edge_multiply(cb.basicMoveCube[j + 3])
                    if not (k1 == 3 and k2 == 3):
                        flip_move[N_MOVE * i + 15 * j + 4 * k1 + k2] = a.get_flip()
        ...
        for j in enums.Axis:
            for k1 in range(4):  # three moves for each face, for example U, U2, U3 = U'
                ...
                for k2 in range(4):
                    a.edge_multiply(cb.basicMoveCube[j + 3])
                    if not (k1 == 3 and k2 == 3):
                        slice_sorted_move[N_MOVE * i + 15 * j + 4 * k1 + k2] = a.get_slice_sorted()
        ...
        for j in enums.Axis:
            for k1 in range(4):  # three moves for each face, for example U, U2, U3 = U'
                ...
                for k2 in range(4):
                    a.edge_multiply(cb.basicMoveCube[j + 3])
                    if not (k1 == 3 and k2 == 3):
                        u_edges_move[N_MOVE * i + 15 * j + 4 * k1 + k2] = a.get_u_edges()
        ...
        for j in enums.Axis:
            for k1 in range(4):  # three moves for each face, for example U, U2, U3 = U'
                ...
                for k2 in range(4):
                    a.edge_multiply(cb.basicMoveCube[j + 3])
                    if not (k1 == 3 and k2 == 3):
                        d_edges_move[N_MOVE * i + 15 * j + 4 * k1 + k2] = a.get_d_edges()
    ...
    for i in range(N_UD_EDGES):
        ...
        for j in enums.Axis:
            for k1 in range(4):  # three moves for each face, for example U, U2, U3 = U'
                ...
                for k2 in range(4):
                    a.edge_multiply(cb.basicMoveCube[j + 3])
                    if j != 0 and (k1 % 2 == 0 or k2 % 2 == 0):
                        continue
                    if not (k1 == 3 and k2 == 3):
                        ud_edges_move[N_MOVE * i + 15 * j + 4 * k1 + k2] = a.get_ud_edges()
        ...
        for j in enums.Axis:
            for k1 in range(4):  # three moves for each face, for example U, U2, U3 = U'
                ...
                for k2 in range(4):
                    a.corner_multiply(cb.basicMoveCube[j + 3])
                    if not (k1 == 3 and k2 == 3):
                        corners_move[N_MOVE * i + 15 * j + 4 * k1 + k2] = a.get_corners()
