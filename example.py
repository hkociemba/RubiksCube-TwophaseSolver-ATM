...
print(a)
a = sv.solve(cubestring, 14, 500)  # solve with a maximum of 18 moves and a timeout of 5 seconds for example
print(a)
quit()
"""
########################################################################################################################
...
background_thread = Thread(target=start_server.start, args=(8080, 15, 100000))
